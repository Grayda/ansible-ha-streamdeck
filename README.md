...
3. Create a file called `credentials.txt` and enter your SSH password. This is optional, but you'll need to modify the `ansible-playbook` command in step 6 if you don't use it
